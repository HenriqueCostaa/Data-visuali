    ...
    dbc.Row([
        dbc.Col([dcc.Graph(id='my_line_chart', figure=fig)],
                style={'width': "30", "margin": "20px", "background-color": color_box,
                       ...
                       'font-family': 'Play', 'font-size' : 18, 'border-width': '4px',
...
# App layout
    ...
    dbc.Row([
        dbc.Col([html.H1("Trip Down Memory Lane", style={'font-family': title_font,
            ...
            [ html.Br(),
                ...
                html.Div(["Find Your Favorite VideoGame: ",
                           dcc.Input(id='game_input', value='', type='text', placeholder='Insert Video Game...',
                                     size='30'), ], style={'color': "#FFFFFF", 'font-family': 'Play', 'font-size' : 18}),
...
page_2_layout =dbc.Container([
    ...
    dbc.Row([
        ...
        html.H2('Joana Rafael',style={"margin": "15px",'color':"#FFFFFF", 'font-family': title_font,
                           'font-size': 55}),
        html.H2('[20200588]', style={"margin": "15px", 'color': "#FFFFFF", 'font-family': def_font,'font-size': 17})

        ],width={'size':1.4, 'offset':0, 'order':1},style={"margin": "15px"}),
        ...
        html.H2('Daniel Correia',style={"margin": "15px",'color':"#FFFFFF", 'font-family': title_font,
                           'font-size': 55}),
        html.H2('[20200665]',style={"margin": "15px",'color':"#FFFFFF", 'font-family':def_font,'font-size': 17}),
        ...
        dbc.Col([html.Div([
            ...
            html.H2('Henrique Costa', style={"margin": "15px", 'color': "#FFFFFF", 'font-family': title_font,
                           'font-size': 55}),
        html.H2('[20200652]', style={"margin": "15px", 'color': "#FFFFFF", 'font-family': def_font,'font-size': 17}),
        ...
        dbc.Col([html.Div([
            ...
            html.H2('Ricardo Santos', style={"margin": "15px", 'color': "#FFFFFF",
                                             'font-family': title_font,
                                             'font-size': 55}
                    ),
    html.H2('[20200620]', style={"margin": "15px", 'color': "#FFFFFF", 'font-family': def_font,'font-size': 17}),
